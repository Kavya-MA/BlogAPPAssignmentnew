            ...
            <div className="main">
                ...
                <div className="signup">
                    <form onSubmit={handleSubmit}>
                        <label for="chk" aria-hidden="false">Sign up</label><br></br>
                        <TextField 
                        margin="normal" 
                        variant="outlined" 
                        fullWidth label="Name"
                       name="name"  required="" value={formValues.name} onChange={handleChange} />
                        ...
                        margin="normal" 
                        variant="outlined" 
                        fullWidth label="ConfirmPassword" name="confirmpassword"  required="" value={formValues.confirmpassword} onChange={handleChange} />
